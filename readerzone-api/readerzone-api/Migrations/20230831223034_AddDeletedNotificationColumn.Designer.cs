...
namespace readerzone_api.Migrations
{
    ...
    [Migration("20230831223034_AddDeletedNotificationColumn")]
    partial class AddDeletedNotificationColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("readerzone_api.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FromCustomerName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FromCustomerSurname")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FromCustomerUsername")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("readerzone_api.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookOrder", b =>
                {
                    ...
                    b.HasOne("readerzone_api.Models.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("readerzone_api.Models.Notification", b =>
                {
                    b.HasOne("readerzone_api.Models.Customer", "ToCustomer")
